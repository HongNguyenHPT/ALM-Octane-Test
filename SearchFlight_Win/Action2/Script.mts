...
WpfWindow("HPE MyFlight Sample Applicatio").WpfComboBox("Class").Select DataTable("class", dtGlobalSheet) @@ hightlight id_;_1883481144_;_script infofile_;_ZIP::ssf12.xml_;_
WpfWindow("HPE MyFlight Sample Applicatio").WpfComboBox("numOfTickets").Select DataTable("numOfTickets", dtGlobalSheet) @@ hightlight id_;_1904788040_;_script infofile_;_ZIP::ssf14.xml_;_
...
'---đặt chuyến bay
WpfWindow("HPE MyFlight Sample Applicatio").WpfEdit("passengerName").Set DataTable("passengerName", dtGlobalSheet) @@ hightlight id_;_1904135232_;_script infofile_;_ZIP::ssf20.xml_;_

DataTable("totalPrice", dtGlobalSheet) = (WpfWindow("HPE MyFlight Sample Applicatio").WpfObject("$1052.82").GetROProperty("text"))
...
a = WpfWindow("HPE MyFlight Sample Applicatio").WpfObject("Order 112 completed").GetROProperty("text")
b = Replace(a, "Order ", "")
