...
Browser("Welcome: Mercury Tours").Page("Find a Flight: Mercury").Image("findFlights").Click 45,12 @@ hightlight id_;_Browser("Welcome: Mercury Tours").Page("Find a Flight: Mercury").Image("findFlights")_;_script infofile_;_ZIP::ssf14.xml_;_
...
Browser("Welcome: Mercury Tours").Page("Select a Flight: Mercury").Image("reserveFlights").Click 55,13 @@ hightlight id_;_Browser("Welcome: Mercury Tours").Page("Select a Flight: Mercury").Image("reserveFlights")_;_script infofile_;_ZIP::ssf17.xml_;_
...
Browser("Welcome: Mercury Tours").Page("Book a Flight: Mercury").Image("buyFlights").Click 29,13 @@ hightlight id_;_Browser("Welcome: Mercury Tours").Page("Book a Flight: Mercury").Image("buyFlights")_;_script infofile_;_ZIP::ssf26.xml_;_
wait (5)
